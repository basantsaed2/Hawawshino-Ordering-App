...
const CheckOutPage = () => {
       ...
       const { postData: postOrder, loadingPost: loadingOrder, response: responseOrder } = usePost({ url: 'https://hawawshinobcknd.food2go.online/customer/make_order', type: true });
